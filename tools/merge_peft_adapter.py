...
def main():
    ...
    if peft_config.task_type == "SEQ_CLS":
        ...
        if is_conditional:
            if AutoModelForConditionalGeneration is None:
                raise ImportError(
                    "AutoModelForConditionalGeneration is not available in this transformers version. "
                    "Please upgrade transformers or use a causal language model."
                )
